/*
    ...
    Arquivo: /app/src/main/java/tech/datatower/sebrae/desafio/data/model/StudentMonitoring.kt
    Descrição: Modelo de domínio representando o snapshot de monitoramento individual de um aluno.
