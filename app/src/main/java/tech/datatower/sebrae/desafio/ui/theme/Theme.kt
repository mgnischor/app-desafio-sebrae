/*
    ...
    Arquivo: /app/src/main/java/tech/datatower/sebrae/desafio/ui/theme/Theme.kt
    Descrição: Configuração do tema Compose da aplicação, incluindo suporte a modo escuro.
