/*
    ...
    Arquivo: /app/src/test/java/tech/datatower/sebrae/desafio/data/auth/AuthManagerTest.kt
    Descrição: Testes unitários do gerenciador de autenticação e persistência de sessão.
