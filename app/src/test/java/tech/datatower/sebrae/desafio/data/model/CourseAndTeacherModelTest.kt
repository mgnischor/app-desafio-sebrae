/*
    ...
    Arquivo: /app/src/test/java/tech/datatower/sebrae/desafio/data/model/CourseAndTeacherModelTest.kt
    Descrição: Testes unitários de modelos de dados de professores e cursos.
