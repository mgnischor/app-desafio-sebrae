/*
    ...
    Arquivo: /core/src/main/java/tech/datatower/sebrae/desafio/domain/usecase/ObserveCertificatesUseCase.kt
    Descrição: UseCase para observar certificados de acordo com o papel do usuário autenticado.
